...
CREATE_STATEMENTS: tuple[str, ...] = (
    ...
    # The owner's linked Telegram chat for schedule notifications, and the on/off toggle.
    """
    ...
    """,
    # One-time, short-lived codes that link a Telegram chat to its owner (see linking flow).
    """
