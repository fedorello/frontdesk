...
const MESSAGES = {
  en: {
    ...
    "settings.charsLeft": "{n} characters left",
    "settings.charsOver": "{n} over the limit",
  ...
  es: {
    ...
    "settings.charsLeft": "{n} caracteres restantes",
    "settings.charsOver": "{n} de más",
  ...
  ru: {
    ...
    "settings.charsLeft": "осталось {n}",
    "settings.charsOver": "превышение на {n}",
  ...
  zh: {
    ...
    "settings.closed": "休息",
    "settings.charsLeft": "还剩 {n} 个字符",
    "settings.charsOver": "超出 {n} 个字符",
