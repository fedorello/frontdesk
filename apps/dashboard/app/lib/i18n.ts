...
const MESSAGES = {
  en: {
    ...
    "chat.title": "Try the assistant",
    "chat.placeholder": "Can I book a haircut?",
    "chat.message": "Message",
    "chat.send": "Send",
    "chat.thinking": "…thinking",
    "chat.error": "⚠️ Couldn't reach the assistant — is the API running on :8000?",
    "chat.demoTitle": "What this demo shows",
    "chat.demoIntro":
      "Frontdesk is an open-source AI front desk for small service businesses — it answers messages, books appointments, and sends reminders. This is {studio}, a demo salon that offers one service ({service}).",
    "chat.demoPoint1": "You're chatting with a real AI agent (a live model) — not a script.",
    "chat.demoPoint2":
    ...
    "chat.demoPoint4": "Time is frozen for the demo, so the slots it offers stay bookable.",
  ...
  es: {
    ...
    "chat.title": "Prueba el asistente",
    "chat.placeholder": "¿Puedo reservar un corte?",
    "chat.message": "Mensaje",
    "chat.send": "Enviar",
    "chat.thinking": "…pensando",
    "chat.error": "⚠️ No se pudo conectar con el asistente — ¿la API está en :8000?",
    "chat.demoTitle": "Qué muestra esta demo",
    "chat.demoIntro":
      "Frontdesk es una recepción con IA de código abierto para pequeños negocios de servicios: responde mensajes, agenda citas y envía recordatorios. Esto es {studio}, un salón de demostración con un servicio ({service}).",
    "chat.demoPoint1": "Hablas con un agente de IA real (un modelo en vivo), no con un guion.",
    "chat.demoPoint2":
      "Pregunta por servicios, consulta horarios y reserva de verdad — escribe en una base de datos real, como un cliente por WhatsApp.",
    "chat.demoPoint3":
      "Abre 🧠 Razonamiento del agente bajo cualquier respuesta para ver sus pensamientos y las herramientas que usó.",
    "chat.demoPoint4":
      "El tiempo está congelado en la demo, así que los horarios que ofrece siguen disponibles.",
  ...
  ru: {
    ...
    "chat.title": "Попробуйте ассистента",
    "chat.placeholder": "Можно записаться на стрижку?",
    "chat.message": "Сообщение",
    "chat.send": "Отправить",
    "chat.thinking": "…думаю",
    "chat.error": "⚠️ Не удалось связаться с ассистентом — API запущен на :8000?",
    "chat.demoTitle": "Что показывает это демо",
    "chat.demoIntro":
      "Frontdesk — open-source ИИ-ресепшн для малого сервисного бизнеса: отвечает на сообщения, записывает на приём и шлёт напоминания. Это {studio} — демо-салон с одной услугой ({service}).",
    "chat.demoPoint1": "Вы общаетесь с настоящим ИИ-агентом (живой моделью), а не со скриптом.",
    "chat.demoPoint2":
      "Спросите про услуги, проверьте время и запишитесь по-настоящему — данные пишутся в реальную БД, как у клиента в WhatsApp.",
    "chat.demoPoint3":
      "Откройте 🧠 «Размышления агента» под любым ответом — увидите мысли агента и вызванные инструменты.",
    "chat.demoPoint4": "Время в демо заморожено, поэтому предлагаемые слоты остаются доступными.",
  ...
  zh: {
    ...
    "chat.title": "试用助手",
    "chat.placeholder": "可以预约理发吗？",
    "chat.message": "消息",
    "chat.send": "发送",
    "chat.thinking": "…思考中",
    "chat.error": "⚠️ 无法连接助手——API 是否运行在 :8000？",
    "chat.demoTitle": "此演示展示的内容",
    "chat.demoIntro":
      "Frontdesk 是面向小型服务企业的开源 AI 前台：回复消息、预约并发送提醒。这是 {studio}——一个提供单一服务（{service}）的演示沙龙。",
    "chat.demoPoint1": "您正在与真实的 AI 智能体（实时模型）对话，而非脚本。",
    "chat.demoPoint2":
      "询问服务、查看时间并真正预约——它会写入真实数据库，就像客户通过 WhatsApp 发消息一样。",
    "chat.demoPoint3": "在任意回复下打开 🧠「智能体推理」，查看其思考过程和调用的工具。",
    "chat.demoPoint4": "演示中时间已冻结，因此它提供的时段始终可预约。",
